      ...
      <AnimatePresence>
        {cardVisible && (
          <motion.div
            ...
            className="relative card-glass border border-green-500/30 rounded-2xl p-4 w-[270px] shadow-2xl shadow-gray-200/80"
          >
            <button
              onClick={dismissCard}
            ...
            <p className="text-gray-900 font-bold text-sm mb-1">Chat with us on WhatsApp</p>
