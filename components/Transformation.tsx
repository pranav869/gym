...
export default function Transformation() {
  return (
    <section id="transformations" className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="card-glass rounded-2xl p-4 flex flex-col gap-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-gray-500 text-xs">{t.duration} at APEX</div>
                  </div>
        ...
        >
          <p className="text-gray-500 text-sm mb-5">
            Over <strong className="text-gray-900">12,000 members</strong> have started their transformation. Will you be next?
          </p>
