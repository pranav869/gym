...
const WHATSAPP_NUMBER = '918838250227'
...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-24 bg-gray-50 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-gray-50/60 via-transparent to-gray-50/60 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="flex items-center gap-3 bg-white border border-gray-200 rounded-2xl px-5 py-3 shadow-sm">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <div className="text-gray-900 font-black text-lg leading-none">4.8</div>
              ...
              <div className="text-gray-500 text-xs">Google Rating · 1,240+ reviews</div>
            </div>
          </div>
          <div className="flex items-center gap-3 bg-white border border-gray-200 rounded-2xl px-5 py-3 shadow-sm">
            ...
            <div>
              <div className="text-gray-900 font-black text-lg leading-none">4.9 <span className="text-gray-400 text-sm font-normal">/ 5</span></div>
              <div className="text-gray-500 text-xs">Facebook · 890+ reviews</div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-500 text-sm">
              <strong className="text-gray-900">12,000+</strong> happy members
            </span>
          </div>
          ...
          <div className="w-px h-8 bg-gray-200 hidden sm:block" />
          <span className="text-gray-500 text-sm">
            <strong className="text-gray-900">98%</strong> member retention rate
          </span>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-400 text-xs mt-3">Join 12,000+ members. First week free.</p>
        </motion.div>
      </div>
    </section>
  )
