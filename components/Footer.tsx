      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 text-zinc-500 text-sm">
                ...
                <span>No 8/5, INTUC Nagar Road,<br />Kolathur, Chennai – 600066</span>
              </div>
              <div className="flex items-center gap-3 text-zinc-500 text-sm">
                <Phone className="w-4 h-4 text-orange-500 flex-shrink-0" />
                <span>+91 8838250227</span>
              </div>
              <div className="flex items-center gap-3 text-zinc-500 text-sm">
        ...
        <div className="mt-12 pt-8 border-t border-zinc-800/60">
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
              ...
              <motion.a
                href="https://maps.app.goo.gl/DntPGCmRaziMKWQX6"
                target="_blank"
            ...
            <div className="rounded-2xl overflow-hidden border border-zinc-800/60 h-56">
              <iframe
                src="https://maps.google.com/maps?q=No+8%2F5,+INTUC+Nagar+Road,+INTUC+Nagar,+Vinayakapuram,+Kolathur,+Chennai,+Tamil+Nadu+600066&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Gym Location – Kolathur, Chennai"
              />
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 pt-6 border-t border-zinc-800/40 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-zinc-600">
          ...
          <p className="flex items-center gap-1">
            Built for champions · Kolathur, Chennai
          </p>
        </div>
      </div>
    </footer>
