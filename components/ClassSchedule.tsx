  ...
  return (
    <section id="classes" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <motion.button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-bold transition-all duration-200 ${
                activeDay === day
                  ...
                  : 'bg-gray-100 text-gray-600 hover:text-orange-500 hover:bg-gray-50'
              }`}
            >
              {day}
            </motion.button>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-semibold border transition-all duration-200 ${
                activeCategory === cat
                  ...
                  : 'border-gray-300/70 text-gray-500 hover:border-gray-400 hover:text-gray-700'
              }`}
            >
              {cat}
            </button>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-center min-w-[52px]">
                      <div className="text-orange-500 font-black text-lg leading-none">{cls.time}</div>
                      <div className="text-gray-400 text-xs mt-1">AM/PM</div>
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        <span className={`text-xs font-semibold border px-2 py-0.5 rounded-full ${intensity.bg} ${intensity.color} bg-opacity-80`}>
                          {cls.intensity}
                        </span>
                      </div>
                    ...
                    {isFull ? (
                      <div className="flex items-center gap-1 text-sm font-bold px-4 py-2 rounded-lg bg-gray-100 text-gray-400 cursor-not-allowed">
                        Full
                      </div>
                    ) : (
                      <motion.a
        ...
        >
          <p className="text-gray-500 text-sm mb-4">All classes included in Pro & Elite memberships</p>
          <motion.a
            href="#pricing"
