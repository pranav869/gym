    ...
    <AnimatePresence>
      {visible && (
        <>
          ...
          >
            <div className="bg-white border border-orange-500/30 rounded-3xl p-8 shadow-2xl shadow-orange-500/10 relative overflow-hidden">
              {/* Glow */}
              ...
              <div className="flex items-center justify-center gap-2 mb-6">
                ...
                <span className="text-gray-500 text-sm">Offer expires in</span>
